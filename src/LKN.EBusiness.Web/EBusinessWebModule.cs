...
public class EBusinessWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(EBusinessResource),
                typeof(EBusinessDomainModule).Assembly,
                typeof(EBusinessDomainSharedModule).Assembly,
                typeof(EBusinessApplicationModule).Assembly,
                typeof(EBusinessApplicationContractsModule).Assembly,
                typeof(EBusinessWebModule).Assembly
            );
        });
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<EBusinessWebModule>();
        });
    }
    ...
    private void ConfigureNavigationServices()
    {
        ...
        {
            options.MenuContributors.Add(new EBusinessMenuContributor());
        });
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "EBusiness API");
        });
        app.UseAuditing();
