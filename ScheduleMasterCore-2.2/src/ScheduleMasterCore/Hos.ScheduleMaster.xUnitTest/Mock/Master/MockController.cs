...
namespace Hos.ScheduleMaster.xUnitTest.Mock.Master
{
    ...
    public class MockController
    {
        public static T CreateMvcController<T>() where T : AdminController, new()
        {
            ...
            //EF数据库上下文
            services.AddDbContext<SmDbContext>(option => option.UseMySql("Data Source=192.168.8.27;Database=schedule_master;User ID=root;Password=123456;pooling=true;CharSet=utf8;port=3306;sslmode=none;TreatTinyAsBoolean=true",ServerVersion.Create(Version.Parse("8.0.23"),Pomelo.EntityFrameworkCore.MySql.Infrastructure.ServerType.MySql)));
            //注入Uow依赖
